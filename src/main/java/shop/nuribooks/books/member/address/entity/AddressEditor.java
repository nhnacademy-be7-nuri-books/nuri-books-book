...
public class AddressEditor {
	...
	private AddressEditor(String name, String zipcode, String address, String detailAddress) {
		this.name = name;
	...
	public static class AddressEditorBuilder {
		...
		public AddressEditor build() {
			return new AddressEditor(this.name, this.zipcode, this.address, this.detailAddress);
		}
