...
public class CouponPolicyController {
	...
	@Operation(summary = "쿠폰 정책 목록 조회", description = "쿠폰 정책 목록을 조회합니다.")
	@ApiResponses(value = {
	...
	public ResponseEntity<Page<CouponPolicyResponse>> getCouponPolicies(Pageable pageable) {
		Page<CouponPolicyResponse> couponPolicyResponses = couponPolicyService.getCouponPolicies(pageable);
