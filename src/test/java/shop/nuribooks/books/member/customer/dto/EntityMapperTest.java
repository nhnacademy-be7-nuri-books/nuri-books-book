...
class EntityMapperTest {
	...
	@DisplayName("EntityMapper 클래스는 인스턴스를 생성할 수 없으며, 기본 생성자는 예외를 던진다.")
	@Test
	void testEntityMapperConstructor() throws NoSuchMethodException {
		// 리플렉션을 이용하여 private 생성자에 접근
		Constructor<EntityMapper> constructor = EntityMapper.class.getDeclaredConstructor();
